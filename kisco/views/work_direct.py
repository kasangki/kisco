...
class WorkDirectManagerView(TemplateView):
    ...
    def make_work_direct(request):
        ...
        # smart_operate_report.kisco_df = smart_op_sum_all_value_df[coef_values_list]
        # case = target_code
        # smart_operate_report.set_values(x_values=coef_values_list, target_value_name=target_code, case=case)
        #
